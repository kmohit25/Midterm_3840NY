...
public class EmployeeInfo extends a_employee implements Employee  {
	...
	public static double calculateEmployeePension(int salary){
		...
		System.out.println("Please enter start date in format (example: January,2019): ");

		String joiningDate = sc.nextLine();

		System.out.println("Please enter today's date in format (example: August,2019): ");

		String todaysDate = sc.nextLine();

		String JoiningDate = DateConversion.convertDate(joiningDate);

		String TodaysDate = DateConversion.convertDate(todaysDate);
		...
		String startYear = JoiningDate.substring(JoiningDate.length()-4);

		String currentYear = TodaysDate.substring(TodaysDate.length()-4);
